...
part 'auth/check_email_verification_use_case.dart';
...
part 'settings/check_email_consistency_use_case.dart';
part 'settings/fetch_current_user_use_case.dart';
part 'settings/fetch_current_locale_use_case.dart';
part 'settings/fetch_current_theme_mode_use_case.dart';
part 'settings/fetch_current_theme_type_use_case.dart';
part 'use_case.dart';
